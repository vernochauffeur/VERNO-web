...
<text x="10" y="32" fontFamily="'Playfair Display',Georgia,serif" fontSize="22" fontWeight="400" fill={ink}>VÉRNO</text>
...
<p className="fleet-text-body">VÉRNO operates a dedicated fleet of premium electric sedans. Each vehicle is maintained to the same exacting standard, so the quality of your transfer is consistent every time.</p>
