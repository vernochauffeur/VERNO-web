...
.hero-outline{
  border:1px solid rgba(158,138,106,.6);
  color:#fff;
}
...
.hero-icon{
  width:55px;
  height:55px;
  border:1px solid rgba(158,138,106,.4);
  border-radius:50%;
  display:flex;
  align-items:center;
...
.hero-bg{
  ...
  inset:0 !important;
  background:
    linear-gradient(90deg, rgba(8,8,8,.88) 0%, rgba(8,8,8,.58) 45%, rgba(8,8,8,.25) 100%),
    linear-gradient(180deg, rgba(0,0,0,.15) 0%, rgba(0,0,0,.78) 100%),
    url("/images/hero-bg.jpg") center/cover no-repeat !important;
  filter:brightness(.9) contrast(1.1) saturate(.95) !important;
}
...
.hero-h1{
  ...
  font-size:clamp(4rem,6.2vw,6.6rem) !important;
...
.hero-gold{
  background:linear-gradient(135deg,#9E7F55,#C0A06F) !important;
  color:#fff !important;
}

.hero-outline{
  border:1px solid rgba(192,160,111,.65) !important;
  color:#fff !important;
...
.hero-service-panel{
  ...
  border:1px solid rgba(192,160,111,.38) !important;
  backdrop-filter:blur(18px) !important;
  box-shadow:0 20px 80px rgba(0,0,0,.35), inset 0 0 30px rgba(255,255,255,.025) !important;
}
...
.hero-icon{
  ...
  border:1px solid rgba(192,160,111,.42) !important;
...
.trust-strip{
  ...
  border-top:1px solid rgba(192,160,111,.12) !important;
