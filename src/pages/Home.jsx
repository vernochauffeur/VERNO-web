...
.s-label{font-size:.68rem;font-weight:500;letter-spacing:.18em;text-transform:uppercase;color:var(–gold);margin-bottom:1.2rem;}
.moments-eyebrow{font-size:.68rem;font-weight:500;letter-spacing:.18em;text-transform:uppercase;color:var(–gold);margin-bottom:1.2rem;}
...
.why-t{font-family:var(–serif);color:#fff;margin:.7rem 0;}
...
.area-name{font-family:var(–serif);margin-bottom:.4rem;}
...
.proc-roman{font-size:2rem;color:var(–gold);opacity:.4;}
.proc-name{font-family:var(–serif);color:#fff;margin:1rem 0;}
...
.testi-txt{font-family:var(–serif);font-style:italic;line-height:1.75;}
...
.closer-sub{color:rgba(255,255,255,.35);}
...
<Services/><Why/><Areas/><Fleet/>
<Process/><Moments/><Testimonials/><Closer/><Footer/>
